        ...
        if ( instance.MODE_DEF == instance.get_mode() ):
            ...
            if ( None == instance.Get_Context() ):
                ...
                if ( "de_DE" == localization ):
                    # Rule R01 ---->
                    # Trace ---->
                    instance.add_rbt_log_message("[SynData] Decision table ItemBuilderEngine (20260226.095446), rule 1 of 9 has been executed", "DEBUG")
                    # Trace <----
                    ...
                    # Rule R02 ---->
                    # Trace ---->
                    instance.add_rbt_log_message("[SynData] Decision table ItemBuilderEngine (20260226.095446), rule 2 of 9 has been executed", "DEBUG")
                    # Trace <----
                ...
                if ( None == instance.get_item(item) ):
                    ...
                    if ( "de_DE" == localization ):
                        # Rule R03 ---->
                        # Trace ---->
                        instance.add_rbt_log_message("[SynData] Decision table ItemBuilderEngine (20260226.095446), rule 3 of 9 has been executed", "DEBUG")
                        # Trace <----
                        # Action A01/02: Call ItemBuilderEngine... / Germany / This item builder is responsible for german test data.
                        retval = ItemBuilderEngineGermany.execute(instance, localization, keyword, item, item_data)
                        ...
                        # Rule R04 ---->
                        # Trace ---->
                        instance.add_rbt_log_message("[SynData] Decision table ItemBuilderEngine (20260226.095446), rule 4 of 9 has been executed", "DEBUG")
                        # Trace <----
                        # Action A01/01: Call ItemBuilderEngine... / Faker / If there is no reliable implementation for the defined localization, Faker is used as a substitute.
                        retval = ItemBuilderEngineFaker.execute(instance, localization, keyword, item, item_data)
                        # Action A03/02: Call for logging / stored / The value should be read from the data structure for logging.
                    ...
                    # Rule R05 ---->
                    # Trace ---->
                    instance.add_rbt_log_message("[SynData] Decision table ItemBuilderEngine (20260226.095446), rule 5 of 9 has been executed", "DEBUG")
                    # Trace <----
                    # Action A03/02: Call for logging / stored / The value should be read from the data structure for logging.
                    value = instance.get_item(item)
                    instance.add_log_entry(keyword, item, value)
            ...
            if ( BuiltIn().get_variable_value("${TEST NAME}") == self.get_recorded_testcase()):
                ...
                if (item == f"{self.recorded_row["item"]}"):
                    # Rule R06 ---->
                    # Trace ---->
                    instance.add_rbt_log_message("[SynData] Decision table ItemBuilderEngine (20260226.095446), rule 6 of 9 has been executed", "DEBUG")
                    # Trace <----
                    ...
                    if ( "de_DE" == localization ):
                        # Rule R07 ---->
                        # Trace ---->
                        instance.add_rbt_log_message("[SynData] Decision table ItemBuilderEngine (20260226.095446), rule 7 of 9 has been executed", "DEBUG")
                        # Trace <----
                        # Action A01/02: Call ItemBuilderEngine... / Germany / This item builder is responsible for german test data.
                        retval = ItemBuilderEngineGermany.execute(instance, localization, keyword, item, item_data)
                        # Action A03/01: Call for logging / local / The locally generated value should be transferred to the logging
                        ...
                        # Rule R08 ---->
                        # Trace ---->
                        instance.add_rbt_log_message("[SynData] Decision table ItemBuilderEngine (20260226.095446), rule 8 of 9 has been executed", "DEBUG")
                        # Trace <----
                        # Action A01/01: Call ItemBuilderEngine... / Faker / If there is no reliable implementation for the defined localization, Faker is used as a substitute.
                        retval = ItemBuilderEngineFaker.execute(instance, localization, keyword, item, item_data)
                        # Action A03/01: Call for logging / local / The locally generated value should be transferred to the logging
                ...
                # Rule R09 ---->
                # Trace ---->
                instance.add_rbt_log_message("[SynData] Decision table ItemBuilderEngine (20260226.095446), rule 9 of 9 has been executed", "DEBUG")
                # Trace <----
