...
class Finance(object):
    ...
    def get_account_data(item_data: dict) -> dict:
        ...
        retval["finance.bank_name"] = data_banks["name"].iloc[row]
        ...
        retval["finance.bank_bic"] = data_bics["bic"].iloc[0]
        account = str(random.randrange(100000,10000000000)).zfill(10)
        retval["finance.bank_iban"] = gf.create_iban("DE", str(data_banks["blz"].iloc[row]) + account )
        return retval
