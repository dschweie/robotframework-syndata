...
# Benötigte Zeit: 00:00:03.432 (14.04.2026 07:54:04.368 - 14.04.2026 07:54:07.800)
# 
...
# 
#     1. Fehler in Testfall 48
#         
#         ItemBuilderEngineGermany
#         | R48 | B02=traffic | B06=else
#         
#         Die dynamisch erzeugte GTD Teilmenge 'item' enthält keine Datensätze. {(item, GherkinItems_de, *, 75 Sätze), (item, item, domain == "traffic", 3 Sätze), (item, item, item == "else", 0 Sätze)}  (14.04.2026 07:54:05.685)
# 
#     2. Fehler in Testfall 63
#         
#         ItemBuilderEngineGermany
#         | R48 | B02=traffic | B06=else
#         
#         Die dynamisch erzeugte GTD Teilmenge 'item' enthält keine Datensätze. {(item, GherkinItems_de, *, 75 Sätze), (item, item, domain == "traffic", 3 Sätze), (item, item, item == "else", 0 Sätze)}  (14.04.2026 07:54:07.793)
# 
...
Feature: Generating test data specifically for Germany
  ...
  Scenario: 0001 ItemBuilderEngineGermany
    ...
    *     rule "1" of "48" from decision table "ItemBuilderEngineGermany" has been executed
  ...
  Scenario: 0002 ItemBuilderEngineGermany
    ...
    *     rule "2" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0003 ItemBuilderEngineGermany
    ...
    *     rule "3" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0004 ItemBuilderEngineGermany
    ...
    *     rule "4" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0005 ItemBuilderEngineGermany
    ...
    *     rule "5" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0006 ItemBuilderEngineGermany
    ...
    *     rule "6" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0007 ItemBuilderEngineGermany
    ...
    *     rule "7" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0008 ItemBuilderEngineGermany
    ...
    *     rule "8" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0009 ItemBuilderEngineGermany
    ...
    *     rule "9" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0010 ItemBuilderEngineGermany
    ...
    *     rule "10" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0011 ItemBuilderEngineGermany
    ...
    *     rule "11" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0012 ItemBuilderEngineGermany
    ...
    *     rule "12" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0013 ItemBuilderEngineGermany
    ...
    *     rule "13" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0014 ItemBuilderEngineGermany
    ...
    *     rule "14" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0015 ItemBuilderEngineGermany
    ...
    *     rule "15" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0016 ItemBuilderEngineGermany
    ...
    *     rule "16" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  Scenario: 0017 ItemBuilderEngineGermany
    ...
    *     rule "17" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0018 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R18 : B01 Context is = None ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.dob
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    *     in SynData no context is set
    When  the builder engine is called:
      | item       | item_data | keyword           |
      | person.dob | {}        | Get Date Of Birth |
    Then  the result for "person.dob" should match "^\d{2}\.\d{2}\.\d{4}"
    *     rule "18" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0019 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R19 : B01 Context is = None ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.ssn
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    *     in SynData no context is set
    When  the builder engine is called:
    ...
    *     rule "19" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0020 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R20 : B01 Context is = None ; B02 Domain of the item is = traffic ; B06 Requested item code of domain "traffic" = traffic.license_plate
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    *     in SynData no context is set
    When  the builder engine is called:
    ...
    *     rule "20" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @datadriven @ddcount_03 @r21 @recommended @rid84
  Scenario: 0021 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R21 : B01 Context is = Set ; B02 Domain of the item is = address ; B11 Geographical reference is = unknown
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "21" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @datadriven @ddcount_03 @r22 @recommended @rid85
  Scenario: 0022 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R22 : B01 Context is = Set ; B02 Domain of the item is = address ; B11 Geographical reference is = given
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    *     in SynData the context "ItemBuilderEngineGermanyR22" with focus "test" and localization "de_DE" is set
    *     in SynData items are stored
      | data_json                   |
      | {"location.ags":"09177133"} |
    When  the builder engine is called:
      | item                  | item_data | keyword               |
      | address.postcode_city | {}        | Get Postcode And City |
    Then  the result for "address.postcode_city" should match "^85445 Oberding.*$"
    *     the internal storage for the following items should be checked:
      | data_json                                                                                                                                                                                                                                                                                                                                                                          |
      | {"address.address":"#stored", "address.address_country":"#stored", "address.city":"Oberding", "address.country":"#stored", "address.country_code":"#stored", "address.house_number":"#stored", "address.postcode":"85445", "address.postcode_city":"#retval", "address.state":"Bayern", "address.street":"#stored", "address.street_address":"#stored", "location.ags":"09177133"} |
    *     rule "22" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0023 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R23 : B01 Context is = Set ; B02 Domain of the item is = communication ; B03 Requested item code of domain "communication" = communication.email ; B08 Item person.first_name is = unknown ; B09 Item person.last_name is = unknown
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "23" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0024 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R24 : B01 Context is = Set ; B02 Domain of the item is = communication ; B03 Requested item code of domain "communication" = communication.email ; B08 Item person.first_name is = unknown ; B09 Item person.last_name is = known
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "24" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0025 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R25 : B01 Context is = Set ; B02 Domain of the item is = communication ; B03 Requested item code of domain "communication" = communication.email ; B08 Item person.first_name is = known ; B09 Item person.last_name is = unknown
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "25" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0026 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R26 : B01 Context is = Set ; B02 Domain of the item is = communication ; B03 Requested item code of domain "communication" = communication.email ; B08 Item person.first_name is = known ; B09 Item person.last_name is = known
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "26" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0027 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R27 : B01 Context is = Set ; B02 Domain of the item is = communication ; B03 Requested item code of domain "communication" = communication.mobile
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "27" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @datadriven @ddcount_02 @r28 @recommended @rid117
  Scenario: 0028 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R28 : B01 Context is = Set ; B02 Domain of the item is = finance ; B11 Geographical reference is = unknown
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "28" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @datadriven @ddcount_02 @r29 @recommended @rid118
  Scenario: 0029 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R29 : B01 Context is = Set ; B02 Domain of the item is = finance ; B11 Geographical reference is = given
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "29" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0030 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R30 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.name ; B08 Item person.first_name is = unknown ; B09 Item person.last_name is = unknown
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "30" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0031 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R31 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.name ; B08 Item person.first_name is = unknown ; B09 Item person.last_name is = known
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "31" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0032 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R32 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.name ; B08 Item person.first_name is = known ; B09 Item person.last_name is = unknown
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "32" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0033 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R33 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.name ; B08 Item person.first_name is = known ; B09 Item person.last_name is = known
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "33" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0034 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R34 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.first_name ; B07 Item person.sex is = unknown
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "34" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @datadriven @ddcount_02 @r35 @recommended @rid110
  Scenario: 0035 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R35 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.first_name ; B07 Item person.sex is = known
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "35" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0036 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R36 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.last_name
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "36" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0037 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R37 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.dob
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     the internal storage for the following items should be checked:
      | data_json                |
      | {"person.dob":"#retval"} |
    *     rule "37" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0038 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R38 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.ssn ; B07 Item person.sex is = unknown ; B09 Item person.last_name is = unknown ; B10 Item person.dob is = unknown
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     rule "38" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0039 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R39 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.ssn ; B07 Item person.sex is = unknown ; B09 Item person.last_name is = unknown ; B10 Item person.dob is = known
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     the internal storage for the following items should be checked:
      | data_json                                                                                              |
      | {"person.ssn":"#retval", "person.sex":"#stored", "person.dob":"#stored", "person.last_name":"#stored"} |
    *     rule "39" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0040 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R40 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.ssn ; B07 Item person.sex is = unknown ; B09 Item person.last_name is = known ; B10 Item person.dob is = unknown
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     the internal storage for the following items should be checked:
      | data_json                                                                                              |
      | {"person.ssn":"#retval", "person.sex":"#stored", "person.dob":"#stored", "person.last_name":"#stored"} |
    *     rule "40" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0041 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R41 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.ssn ; B07 Item person.sex is = unknown ; B09 Item person.last_name is = known ; B10 Item person.dob is = known
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     the internal storage for the following items should be checked:
      | data_json                                                                                              |
      | {"person.ssn":"#retval", "person.sex":"#stored", "person.dob":"#stored", "person.last_name":"#stored"} |
    *     rule "41" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0042 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R42 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.ssn ; B07 Item person.sex is = known ; B09 Item person.last_name is = unknown ; B10 Item person.dob is = unknown
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     the internal storage for the following items should be checked:
      | data_json                                                                                              |
      | {"person.ssn":"#retval", "person.sex":"#stored", "person.dob":"#stored", "person.last_name":"#stored"} |
    *     rule "42" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0043 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R43 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.ssn ; B07 Item person.sex is = known ; B09 Item person.last_name is = unknown ; B10 Item person.dob is = known
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     the internal storage for the following items should be checked:
      | data_json                                                                                              |
      | {"person.ssn":"#retval", "person.sex":"#stored", "person.dob":"#stored", "person.last_name":"#stored"} |
    *     rule "43" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0044 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R44 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.ssn ; B07 Item person.sex is = known ; B09 Item person.last_name is = known ; B10 Item person.dob is = unknown
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     the internal storage for the following items should be checked:
      | data_json                                                                                              |
      | {"person.ssn":"#retval", "person.sex":"#stored", "person.dob":"#stored", "person.last_name":"#stored"} |
    *     rule "44" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0045 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R45 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.ssn ; B07 Item person.sex is = known ; B09 Item person.last_name is = known ; B10 Item person.dob is = known
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    ...
    *     the internal storage for the following items should be checked:
      | data_json                                                                                              |
      | {"person.ssn":"#retval", "person.sex":"#stored", "person.dob":"#stored", "person.last_name":"#stored"} |
    *     rule "45" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0046 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R46 : B01 Context is = Set ; B02 Domain of the item is = traffic ; B06 Requested item code of domain "traffic" = traffic.license_plate ; B11 Geographical reference is = unknown
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    *     in SynData the context "ItemBuilderEngineGermanyR46" with focus "test" and localization "de_DE" is set
    *     in SynData items are stored
      | data_json |
      | {}        |
    When  the builder engine is called:
    ...
    *     rule "46" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @recommended
  Scenario: 0047 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R47 : B01 Context is = Set ; B02 Domain of the item is = traffic ; B06 Requested item code of domain "traffic" = traffic.license_plate ; B11 Geographical reference is = given
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
    *     in SynData the context "ItemBuilderEngineGermanyR47" with focus "test" and localization "de_DE" is set
    *     in SynData items are stored
      | data_json                   |
    ...
    *     rule "47" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log

  @ddcount_00 @incomplete @recommended @skip
  Scenario: 0048 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R48 : B02 Domain of the item is = traffic ; B06 Requested item code of domain "traffic" = else    messages:
    # Die dynamisch erzeugte GTD Teilmenge 'item' enthält keine Datensätze. {(item, GherkinItems_de, *, 75 Sätze), (item, item, domain == "traffic", 3 Sätze), (item, item, item == "else", 0 Sätze)}  (14.04.2026 07:54:05.685)
  ...
  @datadriven @ddbase_0021 @r21 @rid84
  Scenario: 0051 ItemBuilderEngineGermany
    ...
    *     the internal storage for the following items should be checked:
      | data_json                                                                                                                                                                                                                                                                                                                                                                           |
      | {"address.address":"#stored", "address.address_country":"#stored", "address.city":"#stored", "address.country":"#stored", "address.country_code":"#stored", "address.house_number":"#stored", "address.postcode":"#stored", "address.postcode_city":"#stored", "address.state":"#stored", "address.street":"#retval", "address.street_address":"#stored", "location.ags":"#stored"} |
    *     rule "21" of "48" from decision table "ItemBuilderEngineGermany" has been executed
    *     there must be no entry in the internal log
  ...
  @datadriven @ddbase_0022 @r22 @rid85
  ...
  @datadriven @ddbase_0028 @r28 @rid117
  ...
  @datadriven @ddbase_0029 @r29 @rid118
  ...
  @datadriven @ddbase_0035 @r35 @rid110
  Scenario: 0061 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R35 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.first_name ; B07 Item person.sex is = known
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
  ...
  @datadriven @ddbase_0035 @r35 @rid110
  Scenario: 0062 ItemBuilderEngineGermany
    ItemBuilderEngineGermany
    R35 : B01 Context is = Set ; B02 Domain of the item is = person ; B05 Requested item code of domain "person" = person.first_name ; B07 Item person.sex is = known
    Given SynData is in "default" mode and the localization is "de_DE"
    *     that logging for SynData should be done in "SynData-unit_test"
