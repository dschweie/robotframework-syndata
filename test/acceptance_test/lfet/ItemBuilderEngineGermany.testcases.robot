...
...    | Benötigte Zeit: | 00:00:01.811 (14.04.2026 07:54:40.129 - 14.04.2026 07:54:41.940) |
...
...    |  | ⠀⠀⠀⠀Erfolgreich eingelesen: Keywords, 60 Sätze, Encoding UTF-8 |
...
0018 ItemBuilderEngineGermany 
     ...
     [Tags]     ddcount 00     recommended
     ${output}    Get Date Of Birth
     # The output of the keyword is checked against the regular expression to ensure that it is syntactically correct.
     Should Match Regexp    ${output}    pattern=^\\d{2}\\.\\d{2}\\.\\d{4}$
...
0019 ItemBuilderEngineGermany 
     ...
     [Tags]     datadriven     ddcount 03     r19     recommended     rid100
...
0020 ItemBuilderEngineGermany 
     ...
     [Tags]     datadriven     ddcount 04     r20     recommended     rid79
...
0021 ItemBuilderEngineGermany 
     ...
     [Tags]     datadriven     ddcount 04     r21     recommended     rid84
...
0022 ItemBuilderEngineGermany 
     ...
     [Tags]     datadriven     ddcount 04     r22     recommended     rid85
...
0023 ItemBuilderEngineGermany 
     ...
     [Tags]     datadriven     ddcount 03     r23     recommended     rid115
...
0024 ItemBuilderEngineGermany 
     ...
     [Tags]     datadriven     ddcount 03     r24     recommended     rid116
...
0025 ItemBuilderEngineGermany 
     ...
     [Tags]     datadriven     ddcount 03     r25     recommended     rid98
...
0026 ItemBuilderEngineGermany 
     ...
     [Tags]     datadriven     ddcount 03     r26     recommended     rid99
...
0028 ItemBuilderEngineGermany 
     ...
     [Tags]     datadriven     ddcount 02     r28     recommended     rid117
...
0029 ItemBuilderEngineGermany 
     ...
     [Tags]     datadriven     ddcount 02     r29     recommended     rid118
...
0045 ItemBuilderEngineGermany 
     ...
     [Tags]     robot:exclude
     Set Context    TestCaseR45    de_DE    focus=test
     # sex should be known and is pre-assigned by Get First Name.
     ${first_name}    Get First Name    sex=f
     # last name should be known and is pre-assigned.
     ${last_name}    Get Last Name
...
0046 ItemBuilderEngineGermany 
     ...
     [Tags]     datadriven     ddcount 04     r46     recommended     rid82
     Set Context    TestCaseR46    de_DE    focus=test
...
0047 ItemBuilderEngineGermany 
     ...
     [Tags]     ddcount 00     recommended
     Set Context    TestCaseR47    de_DE    focus=test
     # The test case asks for city to ensure geografical reference is set
     ${ref_city}    Get Postcode And City
...
0048 ItemBuilderEngineGermany 
     [Documentation]     ItemBuilderEngineGermany
     ...     | R48 | B02 Domain of the item is = traffic | B06 Requested item code of domain "traffic" = else
     [Tags]     robot:exclude
     ${output}    Get Variable Value    $output    ${EMPTY}
...
0060 ItemBuilderEngineGermany 
     [Documentation]     ItemBuilderEngineGermany
     ...     | R19 | B01 Context is = None | B02 Domain of the item is = person | B05 Requested item code of domain "person" = person.ssn
     [Tags]     datadriven     ddbase 0019     r19     rid100
     ${output}    Get Social Security Number
     # The output of the keyword is checked against the regular expression to ensure that it is syntactically correct.
     Should Match Regexp    ${output}    pattern=^\\d{2}\\s\\d{6}\\s[A-Z]\\s\\d{3}$
...
0063 ItemBuilderEngineGermany 
     [Documentation]     ItemBuilderEngineGermany
     ...     | R20 | B01 Context is = None | B02 Domain of the item is = traffic | B06 Requested item code of domain "traffic" = traffic.license_plate
     [Tags]     datadriven     ddbase 0020     r20     rid79
...
0067 ItemBuilderEngineGermany 
     [Documentation]     ItemBuilderEngineGermany
     ...     | R21 | B01 Context is = Set | B02 Domain of the item is = address | B11 Geographical reference is = unknown
     [Tags]     datadriven     ddbase 0021     r21     rid84
     Set Context    TestCaseR21    de_DE    focus=test
     ${output}    Get House Number
     # The output of the keyword is checked against the regular expression to ensure that it is syntactically correct.
     Should Match Regexp    ${output}    pattern=^\\d\\d?\\d?[A-Ha-h]?$
...
0071 ItemBuilderEngineGermany 
     [Documentation]     ItemBuilderEngineGermany
     ...     | R22 | B01 Context is = Set | B02 Domain of the item is = address | B11 Geographical reference is = given
     [Tags]     datadriven     ddbase 0022     r22     rid85
     Set Context    TestCaseR22    de_DE    focus=test
     # The test case asks for city to ensure geografical reference is set
     ${ref_city}    Get Postcode And City
     ${output}    Get City
...
0075 ItemBuilderEngineGermany 
     [Documentation]     ItemBuilderEngineGermany
     ...     | R23 | B01 Context is = Set | B02 Domain of the item is = communication | B03 Requested item code of domain "communication" = communication.email | B08 Item person.first_name is = unknown | B09 Item person.last_name is = unknown
     [Tags]     datadriven     ddbase 0023     r23     rid115
     Set Context    TestCaseR23    de_DE    focus=test
     ${output}    Get EMail    sex=d
     # The output of the keyword is checked against the regular expression to ensure that it is syntactically correct.
     Should Match Regexp    ${output}    pattern=^.+@.+$
...
0078 ItemBuilderEngineGermany 
     [Documentation]     ItemBuilderEngineGermany
     ...     | R24 | B01 Context is = Set | B02 Domain of the item is = communication | B03 Requested item code of domain "communication" = communication.email | B08 Item person.first_name is = unknown | B09 Item person.last_name is = known
     [Tags]     datadriven     ddbase 0024     r24     rid116
     Set Context    TestCaseR24    de_DE    focus=test
     # last name should be known and is pre-assigned.
     ${last_name}    Get Last Name
     ${output}    Get EMail
...
0081 ItemBuilderEngineGermany 
     [Documentation]     ItemBuilderEngineGermany
     ...     | R25 | B01 Context is = Set | B02 Domain of the item is = communication | B03 Requested item code of domain "communication" = communication.email | B08 Item person.first_name is = known | B09 Item person.last_name is = unknown
     [Tags]     datadriven     ddbase 0025     r25     rid98
     Set Context    TestCaseR25    de_DE    focus=test
     # First name should be known and is pre-assigned.
     ${first_name}    Get First Name
     ${output}    Get EMail    sex=d
...
0084 ItemBuilderEngineGermany 
     [Documentation]     ItemBuilderEngineGermany
     ...     | R26 | B01 Context is = Set | B02 Domain of the item is = communication | B03 Requested item code of domain "communication" = communication.email | B08 Item person.first_name is = known | B09 Item person.last_name is = known
     [Tags]     datadriven     ddbase 0026     r26     rid99
     Set Context    TestCaseR26    de_DE    focus=test
     # First name should be known and is pre-assigned.
     ${first_name}    Get First Name
     # last name should be known and is pre-assigned.
...
0091 ItemBuilderEngineGermany 
     [Documentation]     ItemBuilderEngineGermany
     ...     | R28 | B01 Context is = Set | B02 Domain of the item is = finance | B11 Geographical reference is = unknown
     [Tags]     datadriven     ddbase 0028     r28     rid117
     Set Context    TestCaseR28    de_DE    focus=test
     ${output}    Get Iban
     # The output of the keyword is checked against the regular expression to ensure that it is syntactically correct.
     Should Match Regexp    ${output}    pattern=^DE[0-9]{20}
...
0093 ItemBuilderEngineGermany 
     [Documentation]     ItemBuilderEngineGermany
     ...     | R29 | B01 Context is = Set | B02 Domain of the item is = finance | B11 Geographical reference is = given
     [Tags]     datadriven     ddbase 0029     r29     rid118
     Set Context    TestCaseR29    de_DE    focus=test
     # The test case asks for city to ensure geografical reference is set
     ${ref_city}    Get Postcode And City
     ${output}    Get Bic
...
0095 ItemBuilderEngineGermany 
     [Documentation]     ItemBuilderEngineGermany
     ...     | R46 | B01 Context is = Set | B02 Domain of the item is = traffic | B06 Requested item code of domain "traffic" = traffic.license_plate | B11 Geographical reference is = unknown
     [Tags]     datadriven     ddbase 0046     r46     rid82
     Set Context    TestCaseR46    de_DE    focus=test
